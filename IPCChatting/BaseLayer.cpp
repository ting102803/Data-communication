...
//////////////////////// fill the blank ///////////////////////////////
	SetUnderLayer(pUULayer);//인자로 받은 layer를 하위 layer로
	pUULayer->SetUpperLayer(this);//자신을 상위 layer로
}
...
//////////////////////// fill the blank ///////////////////////////////
	SetUpperLayer(pUULayer);//인자로 받은 layer를 상위 layer로
	pUULayer -> SetUnderLayer(this);//자신을 하위 layer로
}
